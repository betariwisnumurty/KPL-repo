    ...
    <div class="modal-dialog">
        <div class="modal-content">
          	...
          	<div class="modal-body">
                ...
                <hr>
                <div class="form-group">
                    <label for="curr_password" class="col-sm-3 control-label">kata sandi saat ini:</label>

                    <div class="col-sm-9">
                      <input type="password" class="form-control" id="curr_password" name="curr_password" placeholder="Masukan password untuk menyimpan" required>
                    </div>
                </div>
          	</div>
