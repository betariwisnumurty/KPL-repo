      ...
      <div class="row">
        <div class="col-lg-3 col-xs-6">
          ...
          <div class="small-box bg-yellow">
            ...
            <a href="employee.php" class="small-box-footer">Lihat daftar karyawan <i class="fa fa-arrow-circle-right"></i></a>
          </div>
        </div>
        <!-- ./col -->
        <div class="col-lg-3 col-xs-6">
          ...
          <div class="small-box bg-purple">
            ...
            <a href="attendance.php" class="small-box-footer">Lihat daftar presensi <i class="fa fa-arrow-circle-right"></i></a>
          </div>
        </div>
        <!-- ./col -->
        <div class="col-lg-3 col-xs-6">
...
$(function(){
  ...
  var barChartData = {
    ...
    datasets: [
      ...
      {
        label               : 'Tepat Waktu',
        fillColor           : 'rgba(3, 132, 252)',
        strokeColor         : 'rgba(3, 132, 252)',
        pointColor          : 'rgba(3, 132, 252)',
